 ...
 *
 * Disassembly of SSDT-5-CnlU_Rvp.aml
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00002A16 (10774)
 *     Revision         0x02
 *     Checksum         0xCE
 *     OEM ID           "LGE   "
...
DefinitionBlock ("", "SSDT", 2, "LGE   ", "CnlU_Rvp", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.RP05)
    {
        ...
        PowerResource (PXP, 0x00, 0x0000)
        {
            ...
            Method (_ON, 0, NotSerialized)  // _ON_: Power On
            {
                ...
                If (\XINI.CCFG)
                {
                    Notify (\XINI, 0x90) // Device-Specific
                }
            }
    ...
    Scope (\_GPE)
    {
        ...
        {
            OperationRegion (PMIO, SystemIO, (PMBS + 0x60), 0x10)
