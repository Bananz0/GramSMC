 ...
 *
 * Disassembly of SSDT-10-UsbCTabl.aml
 *
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("6f8398c2-7ca4-11e4-ad36-631042b5008f") /* Unknown UUID */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (0x02)
                        {
                            MGI0 = \_SB.PCI0.LPCB.H_EC.MBRD (0x10)
                            MGI1 = \_SB.PCI0.LPCB.H_EC.MBRD (0x11)
                            MGI2 = \_SB.PCI0.LPCB.H_EC.MBRD (0x12)
                            MGI3 = \_SB.PCI0.LPCB.H_EC.MBRD (0x13)
                            MGI4 = \_SB.PCI0.LPCB.H_EC.MBRD (0x14)
                            MGI5 = \_SB.PCI0.LPCB.H_EC.MBRD (0x15)
                            MGI6 = \_SB.PCI0.LPCB.H_EC.MBRD (0x16)
                            MGI7 = \_SB.PCI0.LPCB.H_EC.MBRD (0x17)
                            MGI8 = \_SB.PCI0.LPCB.H_EC.MBRD (0x18)
                            MGI9 = \_SB.PCI0.LPCB.H_EC.MBRD (0x19)
                            MGIA = \_SB.PCI0.LPCB.H_EC.MBRD (0x1A)
                            MGIB = \_SB.PCI0.LPCB.H_EC.MBRD (0x1B)
                            MGIC = \_SB.PCI0.LPCB.H_EC.MBRD (0x1C)
                            MGID = \_SB.PCI0.LPCB.H_EC.MBRD (0x1D)
                            MGIE = \_SB.PCI0.LPCB.H_EC.MBRD (0x1E)
                            MGIF = \_SB.PCI0.LPCB.H_EC.MBRD (0x1F)
