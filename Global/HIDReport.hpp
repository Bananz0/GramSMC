...
#ifndef _HIDReport_hpp
#define _HIDReport_hpp
...
public:
  ...
  const uint8_t (&get_raw_value(void) const)[32] { return keys_; }
  ...
  void clear(void) { memset(keys_, 0, sizeof(keys_)); }
...
public:
  ...
  bool operator==(const consumer_input &other) const {
    return (memcmp(this, &other, sizeof(*this)) == 0);
  }
  bool operator!=(const consumer_input &other) const {
    return !(*this == other);
...
public:
  ...
  bool operator==(const apple_vendor_top_case_input &other) const {
    return (memcmp(this, &other, sizeof(*this)) == 0);
  }
  bool operator!=(const apple_vendor_top_case_input &other) const {
    return !(*this == other);
